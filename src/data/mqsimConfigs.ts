...
// plane with 32 blocks, so the flash grid (Slice 5) can show every block on
// screen at once. Same real MQSim logic, just simulating a smaller SSD -
// this knob becomes user-adjustable later via the Session 9 parameter panel.
export const mappingBasicSsdConfigXml = `<?xml version="1.0" encoding="us-ascii"?>
<Execution_Parameter_Set>
	...
	<Device_Parameter_Set>
		...
		<Flash_Parameter_Set>
			...
			<Page_No_Per_Block>16</Page_No_Per_Block>
...
export const mappingBasicWorkloadXml = `<?xml version="1.0" encoding="us-ascii"?>
<MQSim_IO_Scenarios>
	<IO_Scenario>
